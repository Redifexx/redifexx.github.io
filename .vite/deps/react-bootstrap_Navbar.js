...
import {
  ...
  usePrevious,
  useUncontrolled
} from "./chunk-QQ2IHY7R.js";
import {
  require_classnames,
  require_jsx_runtime,
  useBootstrapPrefix
} from "./chunk-D7GS5E57.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function getReactVersion() {
  const parts = React4.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var useMergedRefs_default2 = useMergedRefs;
...
var TransitionWrapper = import_react4.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
...
var Collapse = import_react5.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react5.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = "0";
  }, onEnter), [computedDimension, onEnter]);
  const handleEntering = (0, import_react5.useMemo)(() => createChainedFunction_default((elem) => {
    const scroll = `scroll${computedDimension[0].toUpperCase()}${computedDimension.slice(1)}`;
    elem.style[computedDimension] = `${elem[scroll]}px`;
  }, onEntering), [computedDimension, onEntering]);
  const handleEntered = (0, import_react5.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  }, onEntered), [computedDimension, onEntered]);
  const handleExit = (0, import_react5.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = `${getDimensionValue(computedDimension, elem)}px`;
    triggerBrowserReflow(elem);
  }, onExit), [onExit, getDimensionValue, computedDimension]);
  const handleExiting = (0, import_react5.useMemo)(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  ...
  return (0, import_jsx_runtime3.jsx)(TransitionWrapper_default, {
    ...
    unmountOnExit,
    appear,
    children: (state, innerProps) => import_react5.default.cloneElement(children, {
      ...innerProps,
...
var NavbarCollapse = React7.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React8.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react9.useContext)(NavbarContext_default) || {};
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react10.useLayoutEffect : import_react10.useEffect;
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react11.useState)(() => mql ? mql.matches : false);
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react12.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Context = (0, import_react15.createContext)(canUseDOM_default ? window : void 0);
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react16.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
var Modal = (0, import_react20.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
...
var Fade = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    onEnter: handleEnter,
...
var AbstractModalHeader = React17.forwardRef(({
  ...
  const context = (0, import_react22.useContext)(ModalContext_default);
...
var divWithClassName_default = (className) => (
  ...
  React19.forwardRef((p, ref) => (0, import_jsx_runtime16.jsx)("div", {
    ...p,
    ref,
...
var OffcanvasTitle = React20.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React21.forwardRef(({
  ...
  const modalManager = (0, import_react23.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react23.useState)(false);
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames11.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames11.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
var NavbarOffcanvas = React22.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context = (0, import_react24.useContext)(NavbarContext_default);
...
var NavbarText = React23.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React24.forwardRef((props, ref) => {
  const {
  ...
  const handleCollapse = (0, import_react25.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react25.useMemo)(() => ({
  ...
  return (0, import_jsx_runtime23.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime23.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime23.jsx)(Component, {
        ref,
        ...controlledProps,
        className: (0, import_classnames13.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
